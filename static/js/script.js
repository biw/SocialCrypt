...
$(document).on("._52lb", "DOMSubtreeModified", function() {
...
$(document).on(".mentionsTextarea", "click", function() {
    $("#enc-area").show()
});

//when the cypher button is clicked
$(document).on("#cypherButton", "click", function() {
    $("#cypherList").toggle()
});

//when a list item is click
$(document).on("#cypherList li", "click", function(x) {
...
$(document).on("#encypt_button", "click", function(x) {
